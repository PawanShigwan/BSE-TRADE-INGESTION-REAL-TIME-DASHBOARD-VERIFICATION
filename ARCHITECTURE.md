...
```
+-------------<img width="1536" height="1024" alt="ChatGPT Image Aug 31, 2026, 04_56_49 PM" src="https://github.com/user-attachments/assets/24c9aa32-54c8-4be2-bc4b-a56157853807" />
--------------------------------------------------------------------------------------+
|                                      SYSTEM ARCHITECTURE                                          |
+---------------------------------------------------------------------------------------------------+
